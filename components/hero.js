...
export default () => (
    <section className="h-screen flex justify-center text-center items-center mx-auto bg-gray-50">
        <div className="px-2 sm:px-0">
            ...
            <h1 className="mx-auto text-4xl max-w-2xl tracking-tight leading-10 font-extrabold text-gray-900 sm:text-5xl sm:leading-none md:text-6xl">Build Your Computer From Scratch</h1>
